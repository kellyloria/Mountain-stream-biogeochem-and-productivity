---
title: 'Revised TASC uptake calculations: for NO3-N'
author: "Kelly Loria"
date: "`r Sys.Date()`"
output:
   html_document:
...
-   Computes injectation N:Cl mass ratio from KNO3 and NaCl masses
...
GBL_NO3_edi_save <- GBL_NO3_processed%>%
  dplyr::select(1:5, 10, 13:15, 17:20, 23, 26)

# write.csv(GBL_NO3_edi_save, "/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/EDI_datasets/TSMQ_GBL_NO3_uptake_observations.csv")
...
*B. 'if(n_distinct(C_mm_ugL) \< 4)': Consider only curves with a real concentration gradient.*
...
```{r, warning=F, echo=F, include=T,  fig.width=8, fig.height=3}
...
p_mm <- ggplot() +
  ...
  geom_point(
    ...
    labs(
    x = expression("Added NO"[3]*" concentration ("*mu*"g L"^{-1}*")"),
...
Possibly one fit on 2022-10-03 is reliable

## *== \> Next reach*

## 2. NO~3~-N uptake at GBU
...
GBU_NO3_edi_save <- GBU_NO3_processed%>%
  dplyr::select(1:5, 10, 13:15, 17:20, 23, 26)

# write.csv(GBU_NO3_edi_save, "/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/EDI_datasets/TSMQ_GBU_NO3_uptake_observations.csv")
...
```{r, warning=F, echo=F, include=T,  fig.width=6, fig.height=3}
...
BWL_NO3_edi_save <- BWL_NO3_processed%>%
  dplyr::select(1:5, 10, 13:15, 17:20, 23, 26)

# write.csv(BWL_NO3_edi_save, "/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/EDI_datasets/TSMQ_BWL_NO3_uptake_observations.csv")
...
```{r, warning=F, echo=F, include=T,  fig.width=8, fig.height=6}
...
Possibly 2022-10-12 is the most reliable rate

## *== \> Next reach*

## 4. NO~3~-N uptake at BWU
...
BWU_NO3_edi_save <- BWU_NO3_processed%>%
  dplyr::select(1:5, 10, 13:15, 17:20, 23, 26)

# write.csv(BWU_NO3_edi_save, "/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/EDI_datasets/TSMQ_BWU_NO3_uptake_observations.csv")
...
```{r, warning=F, echo=F, include=T,  fig.width=4, fig.height=3}
