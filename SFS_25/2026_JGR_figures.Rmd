...
#   scale_color_viridis_d(option = "viridis", name = "Water year") +
  theme_classic() +
          annotate("text", x = 7, y = -28, label = "Lower reach\nlarge creek (BWL)",size =4, fontface = "bold", hjust = 0.5) 
# 
...
#   scale_color_viridis_d(option = "viridis", name = "Water year") +
  theme_classic() +
            annotate("text", x = 7, y = -28, label = "Upper reach\nlarge creek (BWU)", size = 4, fontface = "bold", hjust = 0.5) 
...
GBU_KD_plot <- ggplot() +
 ...
 # scale_color_viridis_d(option = "viridis", name = "Water year") +
  theme_classic() +
        annotate("text", x = 7, y = -28, label = "Upper reach\nsmall creek (GBU)", size = 4, fontface = "bold", hjust = 0.5) 
...
#  geom_contour(data = density_df, aes(x = x, y = y, z = z), color = "black", bins = 10) +
 ...
 #scale_color_viridis_d(option = "viridis",  name = "Water year") +
    scale_color_manual(values=c("#440154", "#3B528B", "#4bcc94","#fad311")) +
  theme_classic() +
      annotate("text", x = 7, y = -28, label = "Lower reach\nsmall creek (GBL)", size = 4, fontface = "bold", hjust = 0.5) 
