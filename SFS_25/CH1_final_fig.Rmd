...
BWL_KD_plot <- ggplot(covariat_datq%>%filter(site=="BWL" &water_year<2025), aes(x = GPP_mean, y = ER_mean, color = as.factor(water_year))) +
...
```{r, warning=F, size = 'small', echo=F, include=FALSE}
# ggsave("/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/Figs/Fig2_KD_CH1_grid_scaled.png", plot = KD_coeff_grid, width = 3, height = 8.5, units = "in")
...
```{r, warning=F, size = 'small', echo=F, include=FALSE}
# ggsave("/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/Figs/Fig4_coeff_ecol_CH1_grid.png", plot = coeff_grid, width = 3.5, height = 12, units = "in")
...
N_ratio_plots <- ggplot(covariat_NS_ND, aes(x = log(NO3_supply+1), y = Ndemand, color = site)) +
  geom_point(size = 2, alpha = 0.75, position = position_dodge(width = 0.3), shape=17) +
    geom_point( aes(x = log(NH4_supply+1), y = Ndemand, color = site),
                size = 2, alpha = 0.75, position = position_dodge(width = 0.3), shape=19) +
...
NO3_supp_plots <- ggplot(covariat_NS_ND%>%filter(NO3_supply<60), aes(y = (NO3_supply), x = jday, color = site)) +
  geom_point(size = 2, alpha = 0.75, position = position_dodge(width = 0.3), shape=17) +
    geom_point( aes(y = NH4_supply, x = jday, color = site), 
                size = 2, alpha = 0.75, position = position_dodge(width = 0.3), shape=19) +
  scale_color_manual(values = site_colors) +
  xlim(15,360) +
  #  ylim(0,5) +
...
N_demand_plot1 <- ggplot(covariat_NS_ND, aes(y = (Ndemand), x = jday, color = site)) +
  geom_point(size = 2.5, alpha = 0.75, position = position_dodge(width = 0.5), shape=1) +
  scale_color_manual(values = site_colors) +
   xlab("Day of year") +
    xlim(15,360) +
...
```{r, warning=F, size = 'small', echo=F, include=F, fig.width=6, fig.height=4}
# ggsave("/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/Figs/Nsupply_grid_CH1.png", plot = Ndyn_grid, width = 9, height = 4, units = "in")
...
```{r, warning=F, size = 'small', echo=F, include=F, fig.width=5, fig.height=3}
...
```{r, warning=F, size = 'small', echo=F, include=T, fig.width=4.75, fig.height=7}
# Create the top row with extra spacing on both sides
...
```{r, warning=F, size = 'small', echo=F, include=F, fig.width=6, fig.height=4}
# ggsave("/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/Figs/Nuptake_CH1_grid_v4.png", plot = Nup_grid4, width = 5.15, height = 11, units = "in")
...
```{r, warning=F, size = 'small', echo=F, include=FALSE,fig.width=6, fig.height=4}
GPP_plots <- ggplot(metab_plots_WY, aes(x = water_year, y = GPP, color = site)) +
  geom_point(size = 3, alpha = 0.95, position = position_dodge(width = 0.3)) +
...
ER_plots <- ggplot(metab_plots_WY, aes(x = water_year, y = ER, color = site)) +
  geom_point(size = 3, alpha = 0.95, position = position_dodge(width = 0.3)) +
  geom_line(position = position_dodge(width = 0.3))+
...
```{r, warning=F, size = 'small', echo=F, include=FALSE,fig.width=6, fig.height=4}
# 
NO3_plots <- ggplot(nuts_plots_WY, aes(x = (water_year), y = NO3_supplym, color = site)) +
  geom_point(size = 3, alpha = 0.95, position = position_dodge(width = 0.3)) +
  geom_line(position = position_dodge(width = 0.3))+
...
NH4_plots <- ggplot(nuts_plots_WY, aes(x = (water_year), y = NH4_supplym, color = site)) +
...
N_demand_plots <- ggplot(nuts_plots_WY, aes(x = (water_year), y = Ndemandm, color = site)) +
  geom_point(size = 3, alpha = 0.95, position = position_dodge(width = 0.3)) +
  geom_line(position = position_dodge(width = 0.3)) +
...
```{r, warning=F, size = 'small', echo=T, fig.width=8, fig.height=6}
...
N_P_plots <- ggplot(Stoich_plot, aes(x = (water_year), y = N_P_ratiom, color = site)) +
  geom_point(size = 3, alpha = 0.95, position = position_dodge(width = 0.3)) +
  geom_line(position = position_dodge(width = 0.3))+
...
```{r, warning=F, size = 'small', echo=F, include=F, fig.width=6, fig.height=4}
# ggsave("/Users/kellyloria/Documents/Publications/CH1\ biogeochem\ linkages/Figs/WY_n_grid_CH1_v2.png", plot = WY_n_grid3, width = 8.5, height = 6.25, units = "in")
